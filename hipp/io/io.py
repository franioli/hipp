...
def gunzip_dir(input_directory, keep=False, verbose=False):
...
def gzip_dir(input_directory, keep=False):
...
def move_files(input_directory, output_directory, extension):
